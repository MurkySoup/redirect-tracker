...
"""
URL Redirection Tracker, Version 0.7.5-alpha (do not distribute)
...
def resp_code_info(code:int):
    ...
    return (next(x for x in resp_code_info if x['code_value'] == code)) or {'code_value':code, 'text':'Unknown', 'Unknown':'Unknown'}
